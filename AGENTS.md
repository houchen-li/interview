...
| `BUILD_SHARED_LIBS`    | Affects third-party dependency linkage only (kosy targets are always SHARED)               |
...
1. Implement functionality. The project is a Python package: C++ sources, headers and Python modules all live together under `src/kosy/`.
